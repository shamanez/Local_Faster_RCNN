...
class FasterRCNNResnetV1FeatureExtractor(   #super classs 
  ...
  def __init__(self,
    ...
    Args:
      architecture: Architecture name of the Resnet V1 model. #name of the achitecture  
      resnet_model: Definition of the Resnet V1 model.     #A function related to resnet 
  ...
  def __init__(self,
    ...
    Raises:
      ValueError: If `first_stage_features_stride` is not 8 or 16,
        or if `architecture` is not supported.
    """
    super(FasterRCNNResnet101FeatureExtractor, self).__init__(    #resnet_v1.resnet_v1_101 - passing the model as a function  
